    ...
    <div class="d-flex">
        ...
        <div class="navbar-brand-box">
            <a href="{{ url('/dashboard') }}" class="logo logo-dark">
                <span class="logo-sm">
                    <img src="{{ asset('assets/admin/images/logo-sm.jpg') }}" alt="" height=" 22">
                </span>
                <span class="logo-lg">
    ...
    <div class="d-flex">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0" aria-labelledby="page-header-notifications-dropdown">
                ...
                <div data-simplebar style="max-height: 230px;">
                    ...
                    <a href="javascript:void(0);" class="text-dark notification-item">
                        <div class="d-flex align-items-start">
                            <div class="flex-shrink-0 me-3">
                                <img src="{{ asset('assets/admin/images/users/avatar-3.jpg') }}" class="rounded-circle avatar-xs" alt="user-pic">
                            </div>
                            <div class="flex-grow-1">
                    ...
                    <a href="javascript:void(0);" class="text-dark notification-item">
                        <div class="d-flex align-items-start">
                            <div class="flex-shrink-0 me-3">
                                <img src="{{ asset('assets/admin/images/users/avatar-4.jpg') }}" class="rounded-circle avatar-xs" alt="user-pic">
                            </div>
                            <div class="flex-grow-1">
        ...
        <div class="dropdown d-inline-block">
            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img class="rounded-circle header-profile-user" src="{{ asset('assets/admin/images/users/avatar-4.jpg') }}" alt="Header Avatar">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                ...
                <a class="dropdown-item" href="{{ route('profile.edit', Auth::user()->id) }}"><i class="uil uil-user-circle font-size-18 align-middle text-muted me-1"></i> View Profile</a>
                ...
                <a class="dropdown-item" href="{{ route('role.index') }}"><i class="uil uil-wallet font-size-18 align-middle me-1 text-muted"></i> Role Management</a>
                <a class="dropdown-item" href="{{ route('permissions.index') }}"><i class="uil uil-wallet font-size-18 align-middle me-1 text-muted"></i> Permission Management</a>
                ...
                <a class="dropdown-item" href="{{ route('changepassword.edit', Auth::user()->id) }}"><i class="uil uil-lock-alt font-size-18 align-middle me-1 text-muted"></i> Change Password</a>
                <form id="frm-logout" action="{{ route('logout') }}" method="POST" style="display: none;">
                    {{ csrf_field() }}
                </form>
                <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('frm-logout').submit();"><i class="uil uil-sign-out-alt font-size-18 align-middle me-1 text-muted"></i> Sign out</a>
