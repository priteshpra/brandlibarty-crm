        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <a href="category.html">CONTENT MANAGEMENT SYSTEM</a>
                </div>
                <div class="card-body">
                    <form class="needs-validation" novalidate action="{{route('cms.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Content</label>
                                    <textarea rows="5" id="summernote" cols="5" name="Content" class="form-control summernote" placeholder="Enter Content" tabindex="2" required></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row ">
                            <div class="col-md-12">
                                <div class="custom-control form-check mb-3">
                                    <input type="checkbox" class="form-check-input" name="Status" id="statuscheck" tabindex="3" required>
